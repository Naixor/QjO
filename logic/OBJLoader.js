		...
		for ( var i = 0; i < lines.length; i ++ ) {
			...
			if ( line.length === 0 || line.charAt( 0 ) === '#' ) {
				...
				geometry.vertices.push(
					this.vertices[ parseInt( result[ 1 ] ) - 1 ],
					this.vertices[ parseInt( result[ 2 ] ) - 1 ],
					this.vertices[ parseInt( result[ 3 ] ) - 1 ]
				);this.mylen=geometry.vertices.length;

				this.vertexIndex.push(
					parseInt( result[ 1 ] ) - 1,
					parseInt( result[ 2 ] ) - 1,
					parseInt( result[ 3 ] ) - 1
				);
				...
				geometry.vertices.push(
					this.vertices[ parseInt( result[ 2 ] ) - 1 ],
					this.vertices[ parseInt( result[ 5 ] ) - 1 ],
					this.vertices[ parseInt( result[ 8 ] ) - 1 ]
				);this.mylen=geometry.vertices.length;
				...
				geometry.vertices.push(
					this.vertices[ parseInt( result[ 2 ] ) - 1 ],
					this.vertices[ parseInt( result[ 6 ] ) - 1 ],
					this.vertices[ parseInt( result[ 10 ] ) - 1 ]
				);this.mylen=geometry.vertices.length;
